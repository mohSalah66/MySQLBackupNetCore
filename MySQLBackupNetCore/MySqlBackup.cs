...
using MySQLBackupNetCore.EventArgs;
using MySQLBackupNetCore.InfoObjects;
using MySQLBackupNetCore.Methods;
using MySQLBackupNetCore.MySqlObjects;

namespace MySQLBackupNetCore
{
